...
export declare class LoadingHelper {
    ...
    /**
     *
     * @param mtlUrls This is only useful when loading obj from local.
     */
    loadObj(url: string, onProgress?: (event: ProgressEvent) => void, mtlUrls?: string[]): Promise<THREE.Object3D>;
